...
class roductController extends Controller
{
    ...
    public function show($id)
    {
       ...
       // 
        $product = DB::table('product')->join('customers','product.id_customer' , '=' , 'customers.id')->select('customers.phone','customers.name','product.name_product','product.id_type_product','product.time_harvest','product.Price_kg','product.amout','product.img_product','product.detail_product','product.id_customer')->where('id_product', $id)->first();
